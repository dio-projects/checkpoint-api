...
public class CompanyService {
    ...
    public MessageResponseDTO updateById(Long id, Company company) throws EntityNotFoundException {
        verifyIfExists(id);
    ...
    private Company verifyIfExists(Long id) throws EntityNotFoundException {
